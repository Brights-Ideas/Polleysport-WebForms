    ...
    <script type="text/javascript">
        ...
        function OnSuccess(response) {
            ...
            customers.each(function () {
                ...
                $("img.product_image", table).attr("src", customer.find("ProductImageUrl").text());//.html(customer.find("ProductImageURL").text());
    ...
    <div class="container">
        <div class="row text-center">
            <form id="form1" runat="server">
                           ...
                           <table>
                                <tr>
                                    ...
                                    <div id="product-item" class="col-sm-4 portfolio-item text-center">
                                        <div class="thumbnail">
                                            <img class="img-responsive product_image" src="<%# Eval("ProductImageURL")%>" alt='<%# Eval("ProductName")%>' />
                ...
                <asp:Repeater ID="rpProducts2" runat="server">

                    <ItemTemplate>
                        <div class="col-sm-4 portfolio-item text-center">
                            <div class="thumbnail">
                                <img class="img-responsive product_name" src="<%# Eval("ProductImageURL")%>" alt='<%# Eval("ProductName")%>' />
